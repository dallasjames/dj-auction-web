...
PastAuctions.defaultProps = {
  title: 'Past Auctions',
  auctions: [
    {
      image: {
        src: '/images/past-auctions/auction-1.jpg',
...
export default function PastAuctions(props) {
  const {
    title,
    auctions,
    open,
  ...
  return (
    <section className="PastAuctions">
      <div className="inner">
        <h2 onClick={() => onOpen('past')} dangerouslySetInnerHTML={{__html: title}}></h2>
